    ...
    public class Evaluator
    {
        ...
        private void ConstructEvaluator(EvaluatorItem[] items)
        {
            ...
            */
            ...
            code.Append("namespace Akmii.DynamicMath { "); //生成代码的命名空间为EvalGuy，和本代码一样
            ...
            _Compiled = a.CreateInstance("Akmii.DynamicMath._Evaluator"); //通过程序集查找并声明 SSEC.Math._Evaluator 的实例
        }
        ...
        {
            Evaluator eval = new Evaluator(typeof(long), code, staticMethodName);//生成 Evaluator 类的对像
        ...
        {
            Evaluator eval = new Evaluator(typeof(decimal), code, staticMethodName);//生成 Evaluator 类的对像
